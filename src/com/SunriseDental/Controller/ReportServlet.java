...
public class ReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.setAttribute("paymentMethodRevenue", reportService.getRevenueByPaymentMethod());
        req.setAttribute("pendingPayments", reportService.getPendingPayments());
        req.setAttribute("pendingPaymentDetails", reportService.getPendingPaymentDetails());
        try {
            req.setAttribute("appointmentsByDentist", reportService.getAppointmentsByDentist(Date.valueOf(dateParam.trim())));
        } catch (IllegalArgumentException ignored) {
            // invalid date already flagged above via the daily-appointments error
        }

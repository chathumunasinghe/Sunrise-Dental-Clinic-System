    ...
    <div class="page-wrapper">
        ...
        <div class="card">
            <ol style="line-height: 2; font-size: 14px;">
                ...
                <li>Open <strong>Payments</strong> to see every patient's paid/unpaid status at a glance (searchable by name, contact number, or appointment number) and jump straight into collecting a payment — available to front desk and admin.</li>

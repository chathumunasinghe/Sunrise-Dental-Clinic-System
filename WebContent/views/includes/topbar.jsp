...
<%
    ...
    else if (currentUri.contains("payments")) { pageTitle = "Payments"; pageIcon = "bi-cash-stack"; }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a class="<%= currentUri.contains("payments") ? "active" : "" %>" href="<%= ctx %>/payments"><i class="bi bi-cash-stack"></i><span>Payments</span></a>
        <% if (isAdminUser) { %>

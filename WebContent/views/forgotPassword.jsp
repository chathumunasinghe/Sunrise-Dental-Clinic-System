...
<body>
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <div class="subtitle">We'll email you a link to reset it</div>
            ...
            <form action="${pageContext.request.contextPath}/forgotPassword" method="post">
                <div class="field-icon">
                    ...
                    <input type="text" name="identifier" placeholder="e.g. admin or admin@sunrisedental.lk" required autofocus />
                </div>

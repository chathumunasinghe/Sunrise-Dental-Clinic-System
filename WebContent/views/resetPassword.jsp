...
<body>
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <div class="subtitle">Enter and confirm your new password below</div>
            ...
            <% } else { %>
                <a class="btn" href="${pageContext.request.contextPath}/views/forgotPassword.jsp" style="display:block; text-align:center;">Request a New Link</a>
            <% } %>

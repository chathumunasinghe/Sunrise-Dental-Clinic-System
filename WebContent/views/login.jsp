        ...
        <div class="auth-card">
            ...
            <div id="tab-patient" class="auth-tab" style="display:<%= patientTab ? "block" : "none" %>;">
                ...
                <form action="${pageContext.request.contextPath}/patientLogin" method="post" autocomplete="off">
                    ...
                    <div class="remember-row">
                        ...
                        <a href="${pageContext.request.contextPath}/patientForgotPassword" style="font-weight:600; text-decoration:none;">Forgot password?</a>
                    </div>
            ...
            <div id="tab-staff" class="auth-tab" style="display:<%= !patientTab ? "block" : "none" %>;">
                ...
                <form action="${pageContext.request.contextPath}/login" method="post" autocomplete="off">
                    ...
                    <div class="remember-row">
                        <label><input type="checkbox" name="rememberMe" /> Remember me</label>
                        <a href="${pageContext.request.contextPath}/forgotPassword" style="font-weight:600; text-decoration:none;">Forgot password?</a>
                    </div>
